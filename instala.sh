...
echo -e "\033[1;36mwget https://raw.githubusercontent.com/NetFreeLaion/ADM-SCRIPT-BY-LAION/master/Install/apt-source.sh && chmod 777 ./* && ./apt-*"
echo -e "${cor[5]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -ne "\033[0m"
exit 1
}
...
wget -O trans https://raw.githubusercontent.com/NetFreeLaion/ADM-SCRIPT-BY-LAION/master/Install/trans -o /dev/null 2>&1
...
echo -e "${cor[1]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -e ""
echo -e "${cor[5]} $(source trans -b pt:${id} "")\n\033[1;37m  Mira mamá, soy un Script :)"
echo -e "${cor[5]} $(source trans -b pt:${id} "")\n\033[1;37m  Y Laion me dio vida nuevamente!"
echo -e "${cor[1]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
...
echo -e "${cor[1]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -ne "${cor[4]}"
wget -O lista https://raw.githubusercontent.com/NetFreeLaion/ADM-SCRIPT-BY-LAION/master/lista -o /dev/null
valid_fun
